...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">server/plugins/security</a> index.js
    </h1>
    <div class='clearfix'>
...
63
64
65</td><td class="line-coverage quiet"><span class="cline-any cline-yes">27x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const csurf = require('csurf');
...
module.exports = {
  ...
  before: [
    ...
    ctx =&gt; {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (ctx.req &amp;&amp; ctx.req.csrfToken) {
