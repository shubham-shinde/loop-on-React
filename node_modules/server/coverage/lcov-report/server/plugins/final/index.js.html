...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">server/plugins/final</a> index.js
    </h1>
    <div class='clearfix'>
...
const statusHandler = async ctx =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!ctx.res) <span class="cstat-no" title="statement not covered" >return;</span>
